...
- Name: document.spec.ts >> Document Model E2E Tests >> T-DOC-001: Create project → verify document model initialized with correct schema >> should create a document with correct schema structure
- Location: document.spec.ts:13:5
