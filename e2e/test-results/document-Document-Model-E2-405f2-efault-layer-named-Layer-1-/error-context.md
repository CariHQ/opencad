...
- Name: document.spec.ts >> Document Model E2E Tests >> T-DOC-001: Create project → verify document model initialized with correct schema >> should create a default layer named "Layer 1"
- Location: document.spec.ts:25:5
