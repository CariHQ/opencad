...
const BUILT_IN_COMMANDS: Omit<Command, 'action'>[] = [
  ...
  { id: 'arc', label: 'Arc', category: '2D Tools' },
  { id: 'polyline', label: 'Polyline', category: '2D Tools' },
  { id: 'polygon', label: 'Polygon', category: '2D Tools' },
  { id: 'dimension', label: 'Dimension', category: '2D Tools' },
  { id: 'view-3d', label: '3D View', category: 'Views' },
  { id: 'view-top', label: 'Floor Plan / Top View', shortcut: '1', category: 'Views' },
  { id: 'view-section', label: 'Section View', shortcut: '3', category: 'Views' },
  { id: 'undo', label: 'Undo', shortcut: '⌘Z', category: 'Edit' },
  { id: 'redo', label: 'Redo', shortcut: '⌘⇧Z', category: 'Edit' },
  { id: 'toggle-ai', label: 'Toggle AI Chat', category: 'Panels' },
  { id: 'import', label: 'Import File (IFC, DXF)', shortcut: '⌘O', category: 'File' },
  { id: 'export', label: 'Export File (IFC, DXF, PDF)', shortcut: '⌘E', category: 'File' },
  { id: 'focus-mode', label: 'Toggle Focus Mode', shortcut: '\\', category: 'View' },
  { id: 'panel-left', label: 'Toggle Left Panel', shortcut: '⌘[', category: 'Panels' },
  { id: 'panel-right', label: 'Toggle Right Panel', shortcut: '⌘]', category: 'Panels' },
  { id: 'history', label: 'Open Version History', category: 'Panels' },
  { id: 'layers', label: 'Open Layers Panel', category: 'Panels' },
  { id: 'properties', label: 'Open Properties Panel', category: 'Panels' },
];
